...
CleanFilterAl :=sortAl(datecollection[7..10]='2021',datecollection[..2]='01', al>0);
COUNT(CleanFilterAl);
...
CleanFilterB :=sortB(datecollection[7..10]='2021',datecollection[..2]='01', b>0);
COUNT(CleanFilterB);
...
CleanFilterCa :=sortCa(datecollection[7..10]='2021',datecollection[..2]='01', ca>0);
COUNT(CleanFilterCa);
...
CleanFilterF :=sortF(datecollection[7..10]='2021',datecollection[..2]='01', f>0);
COUNT(CleanFilterF);
...
CleanFilterFe :=sortFe(datecollection[7..10]='2021',datecollection[..2]='01', fe>0);
COUNT(CleanFilterFe);
...
CleanFilterMg :=sortMg(datecollection[7..10]='2021',datecollection[..2]='01', mg>0);
COUNT(CleanFilterMg);
...
CleanFilterNi :=sortNi(datecollection[7..10]='2021',datecollection[..2]='01', NO3N>0);
COUNT(CleanFilterNi);
...
CleanFilterPh :=sortPh(datecollection[7..10]='2021',datecollection[..2]='01', Ph>0);
COUNT(CleanFilterPh);
...
CleanFilterSd :=sortSd(datecollection[7..10]='2021',datecollection[..2]='01', SecchiDepth > 0);
COUNT(CleanFilterSd);
...
CleanFilterSul :=sortSul(datecollection[7..10]='2021',datecollection[..2]='01', SO4 > 0);
...
CleanFilterTds :=sortTds(datecollection[7..10]='2021',datecollection[..2]='01', TotalDissolvedSolid > 0);
...
CleanFilterTh :=sortTh(datecollection[7..10]='2021',datecollection[..2]='01', TotalHardness >0);
COUNT(CleanFilterTh);
